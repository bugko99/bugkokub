# แนวทางการสร้างDocConverter ด้วย AI

แนวทางนี้แบ่งการทำงานออกเป็น **4 ช่วงหลัก** เพื่อให้การใช้ AI ช่วยพัฒนา DocConverter เป็นระบบ ลดความสับสน ลดการแก้ซ้ำ และควบคุมไม่ให้ AI เขียนโค้ดเกินขอบเขต
...
การใช้ AI พัฒนา DocConverter ควรให้ AI ทำงานเป็นผู้ช่วยตามขั้นตอน ไม่ใช่สั่งให้สร้างทั้งระบบในครั้งเดียว เพราะจะทำให้ระบบควบคุมยาก แก้ไขยาก และมีโอกาสผิดพลาดสูง
